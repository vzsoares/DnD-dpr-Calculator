...
class Attack {
    ...
    getAverageFromDice() {
        return p_hit(this.target_AC, this.getEffectiveAttackBonus(), this.advantage_modifier) * 
    ...
    getAverageTotal() {
        return this.getAverageFromDice() +
...
class Die {
    ...
    getAverageRoll() : number {
        if (this.reroll == 0) {
            ...
            return (T(this.sides) + T(this.minRoll - 1) - this.reroll * this.minRoll - T(this.minRoll) + this.reroll * (new Die(this.sides, 0, this.minRoll)).getAverageRoll()) / this.sides;
        else (this.reroll <= this.minRoll)
            return (T(this.sides) + T(this.minRoll - 1) - this.reroll * this.minRoll + this.reroll * (new Die(this.sides, 0, this.minRoll)).getAverageRoll()) / this.sides;
    }
    getSides() : number {
        return this.sides;
    }
